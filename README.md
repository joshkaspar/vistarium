...
landscape records). Next: additional sources -- see `ROADMAP.md`. A
curated scrape across all 61 National Parks is running as of
2026-09-02 -- see `STATUS.md` for live park-by-park progress.
